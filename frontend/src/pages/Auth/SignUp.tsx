...
import { User, Mail, Lock } from 'lucide-react'; // Icônes
...
const SignUp: React.FC = () => {
  ...
  const handleGoogleSignUp = () => {
    ...
    // Ici, vous lanceriez le processus d'authentification OAuth de Google.
    // Cela impliquerait généralement une redirection vers une URL d'authentification Google
    // ou l'utilisation d'une bibliothèque client Google pour le frontend.
    setError('');
    setSuccess('Redirection vers Google pour l\'inscription...');
  };
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-[#FFF2E6]">
        <div className="max-w-md w-full bg-white p-8 sm:p-10 rounded-2xl shadow-xl space-y-8 border border-gray-100">
          ...
          <div className="text-sm text-center">
            <p className="text-gray-600">
              Déjà un compte ?{' '}
              <a href="/login" className="font-medium text-[#174240] hover:text-[#2E7D32] hover:underline transition duration-150 ease-in-out">
                Connectez-vous ici.
              </a>
            </p>
          </div>
